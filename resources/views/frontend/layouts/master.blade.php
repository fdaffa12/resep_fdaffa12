...
<body>
    ...
    <div class="sl-sideleft">
        ...
        <div class="sl-sideleft-menu">
            ...
            <a href="{{url('racikans')}}" class="sl-menu-link">
                <div class="sl-menu-item">
                    <i class="menu-item-icon icon ion-ios-world-outline tx-22"></i>
                    <span class="menu-item-label">Racikan</span>
                </div><!-- menu-item -->
            </a><!-- sl-menu-link -->
            <a href="{{url('nonracikans/')}}" class="sl-menu-link">
                <div class="sl-menu-item">
                    <i class="menu-item-icon icon ion-ios-world-outline tx-22"></i>
                    <span class="menu-item-label">Non Racikan</span>
                </div><!-- menu-item -->
            </a><!-- sl-menu-link -->
